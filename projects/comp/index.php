<?php include("header.php"); ?>
			...
			<div class="content-wrap">
				...
				<section class="info align-content-Cone-Rtwo">
					<?php
					$info =
					'<h2 class="subhead info-header">Who am I</h2>
					<p>I am a front-end developer based on the East Coast. I aim to contribute to analytically oriented organizations that deliver innovative ideas and create quality relationships that matter.</p>';
				...
				<section class="info align-content-Ctwo-Rtwo">
					<?php
					$info =
					'<h2 class="subhead info-header">My approach</h2>
